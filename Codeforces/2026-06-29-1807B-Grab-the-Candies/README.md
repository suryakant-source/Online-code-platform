...
Mihai and Bianca are playing with bags of candies. They have a row 
a
𝑎
 of 
n
...
𝑎
𝑖
 candies. The bags are given to the players in the order from the first bag to the 
n
𝑛
-th bag.
...
In the first test case, Mihai can reorder the array as follows: 
[4,1,2,3]
[
4
,
...
4
4
 candies, which is even, so Mihai takes it — Mihai has 
4
4
 candies, and Bianca has 
0
0
.
the second bag has 
1
1
 candies, which is odd, so Bianca takes it — Mihai has 
4
4
 candies, and Bianca has 
1
