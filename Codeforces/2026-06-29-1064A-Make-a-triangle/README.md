...
Masha has three sticks of length 
a
𝑎
, 
b
...
The only line contains tree integers 
a
𝑎
, 
b
...
≤
100
) — the lengths of sticks Masha possesses.
...
In the second example, Masha can't make a triangle of positive area from the sticks she has at the beginning, but she can spend one minute to increase the length 
2
2
...
In the third example, Masha can take 
33
33
...
48
48
 centimeters. This way she can form a triangle with lengths 
43
43
, 
58
